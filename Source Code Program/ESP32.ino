...
String wifiSSID = "realme 6";
String wifiPassword = "realme6pro";
...
TBMessage tMessage;
String token = "5783551625:AAHo9pufWDvVNC1F31u0-xwMF2bGuA_fDtY";
CTBot myBot;
...
void loop()
{
    ...
    if (myBot.getNewMessage(tMessage))
    {
        ...
        if (tMessage.messageType == CTBotMessageText)
        {
            ...
            {
                String reply = "";
                reply += "Hi, Welcome "+ tMessage.sender.firstName + " to Kelompok 8 Bot\n";
